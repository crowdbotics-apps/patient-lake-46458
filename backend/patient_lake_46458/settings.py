"""
Django settings for patient_lake_46458 project.
...
ROOT_URLCONF = 'patient_lake_46458.urls'
...
WSGI_APPLICATION = 'patient_lake_46458.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "patient_lake_46458 API",
    "DESCRIPTION": "API documentation for patient_lake_46458 App",
    "VERSION": "v1",
}
